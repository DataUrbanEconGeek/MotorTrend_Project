...
plot_17 <- ggplot(mtcars, aes(x = log(drat), y = log(mpg))) +
                geom_point()
plot_18 <- ggplot(mtcars, aes(x = wt, y = mpg)) +
                geom_point()
plot_19 <- ggplot(mtcars, aes(x = wt, y = log(mpg))) +
                geom_point()
plot_20 <- ggplot(mtcars, aes(x = log(wt), y = log(mpg))) +
                geom_point()
grid.arrange(plot_15, plot_16, plot_17, plot_18, plot_19, plot_20, ncol = 3)
```
